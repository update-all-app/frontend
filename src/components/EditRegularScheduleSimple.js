...
import { time24To12, time12To24 } from '../helpers/functions';
...
export default function EditRegularScheduleSimple(props) {
  ...
  const [displayFormForDays, setDisplayFormForDays] = useState([
    false,
    false,
    false,
    false,
  ...
  const createNewEvent = async (event) => {
    ...
    if (validated) {
      ...
      try {
        ...
        const res = await BusinessApiManager.createRegularEventForLocation(
    ...
    return events.map((e) => {
      return (
        <div className='p-1 bg-secondary w-1/3 flex flex-row items-center justify-between'>
          <span>
            {time24To12(e.start)} - {time24To12(e.end)}
          </span>
  ...
  const dayStatuses = eventsByDay.map((e) =>
    e.length > 0 ? 'Open' : 'Closed'
  );
  ...
  const validateEvent = (newEvent) => {
    ...
    const overlapValidation =
      eventsByDay[newEvent.day].filter((e) => {
      ...
      <div className='flex m-4 ml-24 flex-col'>
        <div className='mt-4'>
          ...
          <div>
            ...
            <div className='m-4'>{displayButtonOrForm(0)}</div>
          </div>
          <div></div>
        </div>
        <div className='mt-4'>
          <h1>
            <span className='my-3 float-left w-32 text-2xl'>Monday</span>
            <span className='my-4 ml-4 inline-flex justify-center px-2 text-tertiary text-lg rounded-sm font-bold'>
              {dayStatuses[1]}
            </span>
          </h1>
          <div>
            ...
            <div className='m-4'>{displayButtonOrForm(1)}</div>
          </div>
          <div></div>
        </div>
        <div className='mt-4'>
          <h1>
            <span className='my-3 float-left w-32 text-2xl'>Tuesday</span>
          ...
          <div>
            ...
            <div className='m-4'>{displayButtonOrForm(2)}</div>
          </div>
          <div></div>
        </div>
        <div className='mt-4'>
          <h1>
            <span className='my-3 float-left w-32 text-2xl'>Wednesday</span>
            <span className='my-4 ml-4 inline-flex justify-center px-2 w-16 text-tertiary text-lg rounded-sm font-bold'>
              {dayStatuses[3]}
            </span>
          </h1>
          <div>
            ...
            <div className='m-4'>{displayButtonOrForm(3)}</div>
          </div>
          <div></div>
        </div>
        <div className='mt-4'>
          <h1>
            <span className='my-3 float-left w-32 text-2xl'>Thursday</span>
            <span className='my-4 ml-4 inline-flex justify-center px-2 w-16 text-tertiary text-lg rounded-sm font-bold'>
              {dayStatuses[4]}
            </span>
          </h1>
          <div>
            ...
            <div className='m-4'>{displayButtonOrForm(4)}</div>
          </div>
          <div></div>
        </div>
        <div className='mt-4'>
          <h1>
            <span className='my-3 float-left w-32 text-2xl'>Friday</span>
            <span className='my-4 ml-4 inline-flex justify-center px-2 w-16 text-tertiary text-lg rounded-sm font-bold'>
              {dayStatuses[5]}
            </span>
          </h1>
          <div>
            ...
            <div className='m-4'>{displayButtonOrForm(5)}</div>
          </div>
          <div></div>
        </div>
        <div className='mt-4'>
          <h1>
            <span className='my-3 float-left w-32 text-2xl'>Saturday</span>
            <span className='my-4 ml-4 inline-flex justify-center px-2 w-16 text-tertiary text-lg rounded-sm font-bold'>
              {dayStatuses[6]}
            </span>
          </h1>
          <div>
            ...
            <div className='m-4'>{displayButtonOrForm(6)}</div>
          </div>
          <div></div>
        </div>
      </div>
