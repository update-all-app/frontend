        ...
        // <div className="mt-0 h-full" >
            <WithFooter>
                ...
                <div className="info-text white flex flex-col justify-center align-left min-h-1/2 p-8">
                    ...
                    <p className="text-primary text-left m-4">
                        Payments are handled by Stripe, and at no point will any sensitive personal information be
                        saved on our servers or transmitted without state-of-the-art encryption.
                    </p>
                    <button 
