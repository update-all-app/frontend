    ...
    <WithFooter>
      ...
      <div className='info-text white flex flex-col justify-center align-left h-1/2 p-8 overflow-scroll'>
        <div className='border-l-2 border-primary shadow-sm'>
          ...
          <p className='text-primary text-left m-4'>
            UpdateItAll is a small business founded by a unique mix of
            restaurant owners, submarine officers, and software experts, all
            committed to saving your small business time that you can use to
