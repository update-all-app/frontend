...
export default function GoogleAddressForm(props) {
  ...
  const showAddressForm = ![streetAddress, route, city, state].every(
    (item) => item === ''
  );
  ...
  return autocompleteManager ? (
    <div className='mt-10'>
      ...
      <div
        className='mt-12 m-auto w-full border-l-2 shadow-lg border-primary flex flex-col justify-start'
        style={{ visibility: showAddressForm ? 'visible' : 'hidden' }}
      >
