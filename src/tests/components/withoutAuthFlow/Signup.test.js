...
describe('Signup', () => {
    describe('When the component is rendered', () => {
        ...
        it('renders the password confirmation field', () => {
            const passwordConfirmationField = document.querySelector('#signup-password-confirmation');
    ...
    describe('Unsuccessful signup', () => {
        ...
        beforeEach(() => {
            ...
            passwordConfirmationField = document.querySelector('#signup-password-confirmation');
        ...
        describe('When the form is not entirely filled out', () => {
            describe('When first name is blank', () => {
                it('renders an error if the sign up button is hit', async () => {
                    ...
                    const errorMessage = await screen.getByText('You must enter a first name');
            ...
            describe('When last name is blank', () => {
                it('renders an error if the sign up button is hit', async  () => {
                    ...
                    fireEvent.click(signupButton);
                    const errorMessage = await screen.getByText('You must enter a last name');
                    expect(errorMessage).toBeInTheDocument();
                });
            });
            ...
            describe('When password is blank', () => {
                it('renders an error if the sign up button is hit', async () => {
                    ...
                    fireEvent.click(signupButton);
                    const errorMessage = await screen.getByText('Password does not meet specifications');
                    expect(errorMessage).toBeInTheDocument();
                });
            });
            ...
            describe('When password confirmation is blank', () => {
                it('renders an error if the sign up button is hit', async () => {
                    ...
                    fireEvent.click(signupButton);
                    const errorMessage = await screen.getByText('Confirmation does not match password');
                    expect(errorMessage).toBeInTheDocument();
                });
            });
        });
        ...
        describe('Validations', () => {
            ...
            describe('When the password does not meet requirements', () => {
                it('renders an error if there are not enough characters', async () => {
                    ...
                    let errorMessage = await screen.getByText('Must have at least 8 characters');
                    expect(errorMessage).toBeInTheDocument();
                    fireEvent.click(signupButton);
                    errorMessage = await screen.getByText('Must have at least 8 characters');
                    expect(errorMessage).toBeInTheDocument()
                });
                ...
                it('renders an error if there are not enough special characters', async () => {
                    ...
                    let errorMessage = await screen.getByText('Contains one of the charcters !,@,#,$,%,^,&');
                    expect(errorMessage).toBeInTheDocument();
                    fireEvent.click(signupButton);
                    errorMessage = await screen.getByText('Contains one of the charcters !,@,#,$,%,^,&');
                    expect(errorMessage).toBeInTheDocument();
                });
                ...
                it('renders an error if there are not enough numbers', async () => {
                    ...
                    let errorMessage = await screen.getByText('Must have at least one number');
                    expect(errorMessage).toBeInTheDocument();
                    fireEvent.click(signupButton);
                    errorMessage = await screen.getByText('Must have at least one number');
                    expect(errorMessage).toBeInTheDocument();
                });
            ...
            describe('When the password confirmation does not meet requirements', () => {
                it('renders an error when the field is not blank', async () => {
                    ...
                    let errorMessage = await screen.getByText('Confirmation does not match password');
                    expect(errorMessage).toBeInTheDocument();
                    fireEvent.click(signupButton);
                    errorMessage = await screen.getByText('Confirmation does not match password');
                    expect(errorMessage).toBeInTheDocument();
                });
            });
            ...
            describe('When the email is taken', () => {
                ...
                it('renders an error if the sign up button is hit', async () => {
                    fireEvent.click(signupButton);
                    const errorMessage = await screen.getByText('Email has already been taken');
                    expect(errorMessage).toBeInTheDocument();
                });
            });
        });
